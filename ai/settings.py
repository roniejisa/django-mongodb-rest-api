...
SECRET_KEY = 'django-insecure-6ni31-jd(t6$tsmofgv221jro(1syouwo0kk7r=6!-^t8lwz3m'
...
DATABASES = {
    'default': {
        'ENGINE': 'djongo',
        'NAME': 'spider_db',
        'ENFORCE_SCHEMA': False,  # Đặt thành True nếu bạn muốn kiểm tra schema
        # 'CLIENT': {
            # 'host': 'mongodb://localhost:27017/spider_db',
            # Hoặc sử dụng các thông số riêng biệt:
            # 'host': 'localhost',
            # 'port': 27017,
            # 'username': 'your_username',
            # 'password': 'your_password',
            # 'authSource': 'admin',  # Tùy thuộc vào cấu hình MongoDB của bạn
        # }
    }
}
